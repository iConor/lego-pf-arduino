...
#define HDR_MARK     158  // The length of the Header:Mark
#define HDR_SPACE   1026  // The lenght of the Header:Space

#define BIT_MARK     158  // The length of a Bit:Mark
#define ONE_SPACE    553  // The length of a Bit:Space for 1's
#define ZERO_SPACE   263  // The length of a Bit:Space for 0's
...
//
#if SEND_LEGO
void  IRsend::sendLego (unsigned long data,  int nbits)
{
